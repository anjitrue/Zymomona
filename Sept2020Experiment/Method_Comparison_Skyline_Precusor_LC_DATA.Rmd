...
df <- ETDIGVTGGGQGK_light_summed
df_heavy <- ETDIGVTGGGQGK_heavy_summed
...
AIEIVDQALDR_light_summed <- Formatting_DFI_Summed_df(DIF_AIEIVDQALDR_MultiPlex,"light","AIEIVDQALDR",c("y7", "y8", "y9"), "no_FAIMS")
AIEIVDQALDR_heavy_summed <- Formatting_DFI_Summed_df(DIF_heavyAIEIVDQALDR_MultiPlex, "heavy","AIEIVDQALDR", c("y7", "y8", "y9"), "no_FAIMS")

ETDIGVTGGGQGK_light_summed <- Formatting_DFI_Summed_df(DIF_ETDIGVTGGGQGK_MultiPlex,"light","ETDIGVTGGGQGK", c( "y7", "y8", "y9"), "no_FAIMS")
ETDIGVTGGGQGK_heavy_summed <- Formatting_DFI_Summed_df(DIF_heavyETDIGVTGGGQGK_MultiPlex, "heavy","ETDIGVTGGGQGK", c( "y7", "y8", "y9"), "no_FAIMS")

AIEIVDQALDR_FAIMS_light_summed <- Formatting_DFI_Summed_df(FAIMS_AIEIVDQALDR_MultiPlex,"light","AIEIVDQALDR",c("y7", "y8", "y9"), "FAIMS")
AIEIVDQALDR_FAIMS_heavy_summed <- Formatting_DFI_Summed_df(FAIMS_heavyAIEIVDQALDR_MultiPlex, "heavy","AIEIVDQALDR", c("y7", "y8", "y9"), "FAIMS")

ETDIGVTGGGQGK_FAIMS_light_summed <- Formatting_DFI_Summed_df(FAIMS_ETDIGVTGGGQGK_MultiPlex,"light","ETDIGVTGGGQGK", c( "y7", "y8", "y9"), "FAIMS")
ETDIGVTGGGQGK_FAIMS_heavy_summed <- Formatting_DFI_Summed_df(FAIMS_heavyETDIGVTGGGQGK_MultiPlex, "heavy","ETDIGVTGGGQGK", c( "y7", "y8", "y9"), "FAIMS")
...
target_ions = c( "y7", "y8", "y9")
AIEIVDQALDR_light_ratio <- FoldChange_DFI(AIEIVDQALDR_light_summed,AIEIVDQALDR_heavy_summed, target_ions)
...
ETDIGVTGGGQGK_light_ratio <- FoldChange_DFI(ETDIGVTGGGQGK_light_summed,ETDIGVTGGGQGK_heavy_summed, target_ions)
...
AIEIVDQALDR_FAIMS_light_ratio <- FoldChange_DFI(AIEIVDQALDR_FAIMS_light_summed,AIEIVDQALDR_FAIMS_heavy_summed, target_ions)
...
ggplot(Combined_Ratio_SpikeMatrixLadder_ETDIGVTGGGQGK_All_ordered, aes(x= Group.1, y=x, group = IonMobility)) +
  geom_point(aes(color = IonMobility)) +
  ...
  labs(title = "Standard Spiked in Matrix", subtitle = "Light to Heavy Ratio - ETDIGVTGGGQGK",
       x = "Concentration (fmol/uL)", y = "Light to Heavy Ratio")
...
ggplot(Combined_Ratio_SpikeMatrixLadder_AIEIVDQALDR_All_ordered, aes(x= Group.1, y=x, group = IonMobility)) +
  geom_point(aes(color = IonMobility)) +
  #geom_line(aes(color = "black")) +
  geom_errorbar(aes(ymin = x-stdev, ymax = x+stdev),
                alpha = 0.2,
  ...
  theme_classic()+
  theme(axis.text.x = element_text(angle = 50, hjust = 1))+
  labs(title = "Standard Spiked in Matrix", subtitle = "Light to Heavy Ratio - AIEIVDQALDR",
       x = "Concentration (fmol/uL)", y = "Light to Heavy Ratio")
