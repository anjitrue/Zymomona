---
title: "Supplemental Heatmaps FAIMS ETDDIGVTGGGQGK 0.4,1,2 IW"
author: "Anji"
date: "April 30, 2021"
...
ETDIGVTGGGQGK_CompiledFragments_0_4_FAIMS_20ppm <- read.csv("F:/Projects/Proteomics/Zymomona/FAIMS/DataAnalysis/HeatMaps/CompiledFragmentResults_ETDIGVTGGGQGK_IW_0_4_Zymo_FAIMS_20ppm.csv", 
                                        header = TRUE, sep = ",", stringsAsFactors = FALSE)


ETDIGVTGGGQGK_CompiledFragments_1_FAIMS_20ppm <- read.csv("F:/Projects/Proteomics/Zymomona/FAIMS/DataAnalysis/HeatMaps/CompiledFragmentResults_ETDIGVTGGGQGK_IW_1_Zymo_FAIMS_20ppm.csv", 
                                        header = TRUE, sep = ",", stringsAsFactors = FALSE)

ETDIGVTGGGQGK_CompiledFragments_2_FAIMS_20ppm <- read.csv("F:/Projects/Proteomics/Zymomona/FAIMS/DataAnalysis/HeatMaps/CompiledFragmentResults_ETDIGVTGGGQGK_IW_2_Zymo_FAIMS_20ppm.csv", 
                                        header = TRUE, sep = ",", stringsAsFactors = FALSE)
...
#x = ETDIGVTGGGQGK_CompiledFragments_0_4_FAIMS_20ppm
...
ETDIGVTGGGQGK_meta_0_4_FAIMS_20ppm  <- meta_replicates(ETDIGVTGGGQGK_CompiledFragments_0_4_FAIMS_20ppm)
ETDIGVTGGGQGK_df_0_4_FAIMS_log2_20ppm <- df_fragments_log2(ETDIGVTGGGQGK_CompiledFragments_0_4_FAIMS_20ppm, ETDIGVTGGGQGK_meta_0_4_FAIMS_20ppm)

ETDIGVTGGGQGK_annotation_0_4_FAIMS_20ppm <- replicate_annotation(ETDIGVTGGGQGK_df_0_4_FAIMS_log2_20ppm, ETDIGVTGGGQGK_meta_0_4_FAIMS_20ppm)


### IW 1
ETDIGVTGGGQGK_meta_1_FAIMS_20ppm  <- meta_replicates(ETDIGVTGGGQGK_CompiledFragments_1_FAIMS_20ppm)
ETDIGVTGGGQGK_df_1_FAIMS_log2_20ppm <- df_fragments_log2(ETDIGVTGGGQGK_CompiledFragments_1_FAIMS_20ppm, ETDIGVTGGGQGK_meta_1_FAIMS_20ppm)

ETDIGVTGGGQGK_annotation_1_FAIMS_20ppm <- replicate_annotation(ETDIGVTGGGQGK_df_1_FAIMS_log2_20ppm, ETDIGVTGGGQGK_meta_1_FAIMS_20ppm)

### IW 2
ETDIGVTGGGQGK_meta_2_FAIMS_20ppm  <- meta_replicates(ETDIGVTGGGQGK_CompiledFragments_2_FAIMS_20ppm)
ETDIGVTGGGQGK_df_2_FAIMS_log2_20ppm <- df_fragments_log2(ETDIGVTGGGQGK_CompiledFragments_2_FAIMS_20ppm, ETDIGVTGGGQGK_meta_2_FAIMS_20ppm)

ETDIGVTGGGQGK_annotation_2_FAIMS_20ppm <- replicate_annotation(ETDIGVTGGGQGK_df_2_FAIMS_log2_20ppm, ETDIGVTGGGQGK_meta_2_FAIMS_20ppm)
```

```{r heatmap_prep, echo=FALSE}
theme_set(theme_bw(base_size = 16))

dat <- data.frame(values = as.numeric(as.matrix(ETDIGVTGGGQGK_df_2_FAIMS_log2_20ppm)))
ggplot(dat, aes(values)) + geom_density(bw = "SJ")

## ----uniform-color-breaks------------------------------------------------
mat_breaks <- seq(min(ETDIGVTGGGQGK_df_2_FAIMS_log2_20ppm), max(ETDIGVTGGGQGK_df_2_FAIMS_log2_20ppm), length.out = 10)
...
dat2 <- as.data.frame(table(cut(
  as.matrix(ETDIGVTGGGQGK_df_2_FAIMS_log2_20ppm), mat_breaks
)))
dat2$fill <- scaleRYG
ggplot() +
  geom_bar(
...
pheatmap(ETDIGVTGGGQGK_df_0_4_FAIMS_log2_20ppm,
         #annotation = annotation_res,
         annotation_colors = my_colour,
         annotation_col = ETDIGVTGGGQGK_annotation_0_4_FAIMS_20ppm,
         color = scaleRYG,
         #scale = "row",
         ...
         gaps_row = c(1,12),
         show_colnames = F,
         main = "ETDIGVTGGGQGK IW of 0.4 m/z with FAIMS 20ppm")

pheatmap(ETDIGVTGGGQGK_df_1_FAIMS_log2_20ppm,
         #annotation = annotation_res,
         annotation_colors = my_colour,
         annotation_col = ETDIGVTGGGQGK_annotation_1_FAIMS_20ppm,
         color = scaleRYG,
         #scale = "row",
         breaks = c(0,7,9,11,14,15,16,17,19,22),
         cluster_rows = FALSE,
         cluster_cols = FALSE,
         gaps_col =c(9,18,27),
         gaps_row = c(1,12),
         show_colnames = F,
         main = "ETDIGVTGGGQGK IW of 1 m/z with FAIMS 20ppm")

pheatmap(ETDIGVTGGGQGK_df_2_FAIMS_log2_20ppm,
         #annotation = annotation_res,
         annotation_colors = my_colour,
         annotation_col = ETDIGVTGGGQGK_annotation_2_FAIMS_20ppm,
         color = scaleRYG,
         #scale = "row",
         ...
         gaps_row = c(1,12),
         show_colnames = F,
         main = "ETDIGVTGGGQGK IW of 2 m/z with FAIMS 20ppm")
```

```{r log2_unique, echo=FALSE}

ETDIGVTGGGQGK_unique_annotation_0_4_FAIMS_20ppm <- unique_annotation(ETDIGVTGGGQGK_annotation_0_4_FAIMS_20ppm)
ETDIGVTGGGQGK_averaged_0_4_FAIMS_log2_20ppm <- averagedIntensity(ETDIGVTGGGQGK_df_0_4_FAIMS_log2_20ppm, ETDIGVTGGGQGK_meta_0_4_FAIMS_20ppm)

## 1 IW
ETDIGVTGGGQGK_unique_annotation_1_FAIMS_20ppm <- unique_annotation(ETDIGVTGGGQGK_annotation_1_FAIMS_20ppm)
ETDIGVTGGGQGK_averaged_1_FAIMS_log2_20ppm <- averagedIntensity(ETDIGVTGGGQGK_df_1_FAIMS_log2_20ppm, ETDIGVTGGGQGK_meta_1_FAIMS_20ppm)

## 2 IW
ETDIGVTGGGQGK_unique_annotation_2_FAIMS_20ppm <- unique_annotation(ETDIGVTGGGQGK_annotation_2_FAIMS_20ppm)
ETDIGVTGGGQGK_averaged_2_FAIMS_log2_20ppm <- averagedIntensity(ETDIGVTGGGQGK_df_2_FAIMS_log2_20ppm, ETDIGVTGGGQGK_meta_2_FAIMS_20ppm)
...
pdf("F:/Projects/Proteomics/Zymomona/FAIMS/Figures/FromR/Parameter_Comparisono_HeatMaps/20ppm/ETDIGVTGGGQGK_averaged_0_4_FAIMS_log2_20ppm_heatmap.pdf", width = 7, height = 11,useDingbats = FALSE)
pheatmap(ETDIGVTGGGQGK_averaged_0_4_FAIMS_log2_20ppm,
         annotation_colors = my_colour,
         annotation_col = ETDIGVTGGGQGK_unique_annotation_0_4_FAIMS_20ppm,
         color = scaleRYG,
         breaks = c(0,7,9,11,14,15,16,17,19,21),
         cluster_rows = FALSE,
         cluster_cols = FALSE,
         ...
         width = 7,
         height = 11,
         main = "ETDIGVTGGGQGK IW of 0.4 Da with FAIMS")
dev.off()

pdf("F:/Projects/Proteomics/Zymomona/FAIMS/Figures/FromR/Parameter_Comparisono_HeatMaps/20ppm/ETDIGVTGGGQGK_averaged_1_FAIMS_log2_20ppm_heatmap.pdf", width = 7, height = 11,useDingbats = FALSE)
pheatmap(ETDIGVTGGGQGK_averaged_1_FAIMS_log2_20ppm,
         annotation_colors = my_colour,
         annotation_col = ETDIGVTGGGQGK_unique_annotation_1_FAIMS_20ppm,
         color = scaleRYG,
         ...
         width = 7,
         height = 11,
         main = "ETDIGVTGGGQGK IW of 1 m/z with FAIMS")
dev.off()

pdf("F:/Projects/Proteomics/Zymomona/FAIMS/Figures/FromR/Parameter_Comparisono_HeatMaps/20ppm/ETDIGVTGGGQGK_averaged_2_FAIMS_log2_20ppm_heatmap.pdf", width = 7, height = 11,useDingbats = FALSE)
pheatmap(ETDIGVTGGGQGK_averaged_2_FAIMS_log2_20ppm,
         annotation_colors = my_colour,
         annotation_col = ETDIGVTGGGQGK_unique_annotation_2_FAIMS_20ppm,
         color = scaleRYG,
         breaks = c(0,7,9,11,14,16,17,19,21,22),
         cluster_rows = FALSE,
         cluster_cols = FALSE,
         ...
         width = 7,
         height = 11,
         main = "ETDIGVTGGGQGK IW of 2 m/z with FAIMS")
dev.off()
```
...
E_FAIMS_0_4 <- pheatmap(ETDIGVTGGGQGK_averaged_0_4_FAIMS_log2_20ppm,
         annotation_colors = my_colour,
         annotation_col = ETDIGVTGGGQGK_unique_annotation_0_4_FAIMS_20ppm,
         color = scaleRYG,
         breaks = c(0,7,9,11,14,15,16,17,19,21),
...
E_FAIMS_1 <- pheatmap(ETDIGVTGGGQGK_averaged_1_FAIMS_log2_20ppm,
         annotation_colors = my_colour,
         annotation_col = ETDIGVTGGGQGK_unique_annotation_1_FAIMS_20ppm,
         color = scaleRYG,
         breaks = c(0,7,9,11,14,15,16,18,20,22),
...
E_FAIMS_2 <- pheatmap(ETDIGVTGGGQGK_averaged_2_FAIMS_log2_20ppm,
         annotation_colors = my_colour,
         annotation_col = ETDIGVTGGGQGK_unique_annotation_2_FAIMS_20ppm,
         color = scaleRYG,
         breaks = c(0,7,9,11,14,16,17,19,21,22),
...
pdf("F:/Projects/Proteomics/Zymomona/FAIMS/Figures/FromR/Parameter_Comparisono_HeatMaps/20ppm/ETDIGVTGGGQGK_averaged_0_4_1_2_FAIMS_log2_20ppm_heatmap.pdf", width = 60, height = 15,useDingbats = FALSE)
...
#### Will not move forward with this in supplemental
```{r ETDIGVTGGGQGK_compiled_y7y8y9, echo=FALSE}
ETDIGVTGGGQGK_y7y8y9_0_4_FAIMS_20ppm <- df_y7y8y9_norm(ETDIGVTGGGQGK_CompiledFragments_0_4_FAIMS_20ppm)
